...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL . 'assets/dashboard/css/index.css' ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.1.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.12.1/css/dataTables.bootstrap5.min.css">

    <title>PHP Native | Dashboard</title>
</head>
        ...
        <aside class="cart-sidebar">
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <button class="nav-btn" onclick="toggleRightSidebar()">
                    <img src="<?= BASE_URL . 'assets/dashboard/assets/img/global/cart/fi_x-1.svg' ?>" alt="">
                </button>
            </div>
            ...
            <div class="w-100 food-card d-flex justify-content-between align-items-center">
                <div class="w-100 d-flex justify-content-start align-items-center">
                    <div class="food-img">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/food/photo-3.png" alt="">
                    </div>
                ...
                <div class="d-flex justify-content-start align-items-center">
                    <button class="btn-number decrease" onclick="decreaseNumber(this)">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/cart/minus.svg" alt="">
                    </button>
                    <input class="input-number" type="text" value="12" disabled>
                    <button class="btn-number" onclick="increaseNumber(this)">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/cart/fi_x.svg" alt="">
                    </button>
                </div>
            </div>
            ...
            <div class="w-100 food-card d-flex justify-content-between align-items-center">
                <div class="w-100 d-flex justify-content-start align-items-center">
                    <div class="food-img">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/food/photo-4.png" alt="">
                    </div>
            ...
            <div class="w-100 food-card d-flex justify-content-between align-items-center">
                <div class="w-100 d-flex justify-content-start align-items-center">
                    <div class="food-img">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/food/photo-2.png" alt="">
                    </div>
            ...
            <div class="w-100 food-card d-flex justify-content-between align-items-center">
                <div class="w-100 d-flex justify-content-start align-items-center">
                    <div class="food-img">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/food/photo-5.png" alt="">
                    </div>
        ...
        <div class="col-12 col-lg-2 col-xl-1 col-navbar d-block">
            ...
            <aside class="sidebar">
                <div class="d-flex flex-column justify-content-center align-items-center sidebar-top">
                    ...
                    <a href="#">
                        <img src="<?= BASE_URL . 'assets/dashboard/' ?>./assets/img/global/logo.svg" alt="">
                    </a>
                ...
                <div class="sidebar-item-container d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="/dashboard/my-post" class="sidebar-item" onclick="toggleActive(this)">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-start">
                        ...
                        <div class="d-none d-sm-flex flex-column justify-content-start align-items-start">
                            <h2 class="nav-title">Hi, <?= $data['user']['name'] ?> 👋</h2>
                            <h5 class="nav-desc">Welcome Back</h5>
                        </div>
                    </div>
